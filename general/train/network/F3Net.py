...
class ResNet(nn.Module):
    ...
    def initialize(self):
        self.load_state_dict(torch.load('/home/ziyun/Desktop/Project/esophagus/code/github/resnet50-19c8e357.pth'), strict=False)
...
class F3Net(nn.Module):
    def __init__(self, pretrained=None):
        ...
        self.linearp1 = nn.Conv2d(64, 8, kernel_size=3, stride=1, padding=1)
        self.linearp2 = nn.Conv2d(64, 8, kernel_size=3, stride=1, padding=1)

        self.linearr2 = nn.Conv2d(64, 8, kernel_size=3, stride=1, padding=1)
        self.linearr3 = nn.Conv2d(64, 8, kernel_size=3, stride=1, padding=1)
        self.linearr4 = nn.Conv2d(64, 8, kernel_size=3, stride=1, padding=1)
        self.linearr5 = nn.Conv2d(64, 8, kernel_size=3, stride=1, padding=1)
        self.initialize()
