...
class _DataSet(object):
    ...
    def getNames(self):
        ...
        # print(paths[0][0],paths[1][0])
        #former one: name of image, latter one: name of gt
...
class DataSet(_DataSet):
    ...
    def getBatch(self, batch):
        ...
        OutPuts = {
            ...
            'Conn':np.empty((batch,8, b_size, b_size), dtype=np.float32)
        }
        ...
        for idx in range(batch):
            ...
            OutPuts['X'][idx], OutPuts['Y'][idx], OutPuts['C'][idx],OutPuts['Conn'][idx] = X, Y, C,connect
            self.index += 1
