...
def args(mode):
    ...
    if mode == 'train':
        ...
        parser.add_argument('--lr', default=0.005, type=float, help='set base learning rate')
    ...
    parser.add_argument('--vals', default='ECSSD', help='Validation sets')
...
class Loader(object):
    ...
    def loading(self, opt):
        ...
        if self.debug:
            ...
            self.vals = ['PASCAL-S', 'ECSSD', 'DUTS-TE', 'HKU-IS', 'DUT-OMRON']
        else:
            self.vals = [opt.vals, ]
