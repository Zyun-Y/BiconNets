...
class GCPANet(nn.Module):
    def __init__(self,num_class):
        ...
        self.linear5 = nn.Conv2d(256, num_class, kernel_size=3, stride=1, padding=1)
        self.linear4 = nn.Conv2d(256, num_class, kernel_size=3, stride=1, padding=1)
        self.linear3 = nn.Conv2d(256, num_class, kernel_size=3, stride=1, padding=1)
        self.linear2 = nn.Conv2d(256, num_class, kernel_size=3, stride=1, padding=1)
        self.initialize()
