...
from network.deeplab_resnet import resnet50_locate
from network.vgg import vgg16_locate
...
class PoolNet(nn.Module):
    ...
    def forward(self, x):
        ...
        merge = self.score_1(merge, x_size)
        return merge
