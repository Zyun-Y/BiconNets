...
class Data(Dataset):
    def __init__(self, cfg, mode):
        ...
        if self.cfg.mode=='train':
            ...
            for im in image_ls:
                ...
                conn = im.split('imgs')[0]+'connect'+im.split('imgs')[1].split('.jpg')[0]+'.npy'
    ...
    def __getitem__(self, idx):
        ...
        # print(image.shape,image2.shape,conn.shape)
        shape = mask.shape
        ...
        #     # print(image.shape, mask.shape, conn.shape)
        ...
        if self.cfg.mode=='train':
            ...
            return image, mask.unsqueeze(0),name, shape
